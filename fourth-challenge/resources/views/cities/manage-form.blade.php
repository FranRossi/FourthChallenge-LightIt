...
<div class="space-y-10 divide-y divide-gray-900/10">
        ...
        <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2 flex items-center gap-x-3">
              ...
              <button type="button" class="rounded-md bg-white py-1.5 px-2.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Change</button>
            </div>
          </div>
  ...
  <div class="grid grid-cols-1 gap-y-8 gap-x-8 pt-10 md:grid-cols-3">
    ...
    <form class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
      <div class="px-4 py-6 sm:p-8">
        <div class="grid max-w-2xl grid-cols-1 gap-y-8 gap-x-6 sm:grid-cols-6">
